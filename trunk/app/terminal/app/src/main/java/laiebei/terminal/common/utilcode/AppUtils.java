...
public class AppUtils {
     ...
     *
     * */
    public static void killForcible(Context context){
        // 退出程序
        SuUtils.kill(context.getPackageName());
    }
    ...
    public static String getAppAbsoluteVersion(Context context){
     ...
     * 获取APP UUID
     * */
    public static int getAppUuid(Context context,String packageName ){
        if (StringUtils.isSpace(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            ApplicationInfo pi = pm.getApplicationInfo(packageName, 0);
            return pi == null ? -1 : pi.uid;
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            return -1;
        }
     ...
     * 获取本APP   UUID
     * */
    public static int getAppUuid(Context context){
        return getAppUuid(context,context.getPackageName());
    }
    ...
    /**
     * 获取Manifest中的meta-data
     * */
    public static String getMeta(Context context, String metaName){
        ...
        try {
            ...
            if(appInfo != null){
                String metaData = appInfo.metaData.getString(metaName);
                return metaData;
            }
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
