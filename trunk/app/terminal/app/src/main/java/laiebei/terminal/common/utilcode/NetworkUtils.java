...
//    private static long networkBreakTimes = 0;
//    private static void networkBreak(Context context){
//        networkBreakTimes++;
//        //每断开8次记录数据
//        if((context != null) && ((networkBreakTimes%8) == 0)){
//            maintainXml xml = new maintainXml(context);
//            xml.setNetworkBadTimes( String.valueOf(networkBreakTimes));
//        }
//    }
