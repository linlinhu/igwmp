...
var EM={};
EM.grid = Ext.extend(Ext.grid.GridPanel,{
	
});
EM.gridToolbar = Ext.extend(Ext.PagingToolbar,{
	pageSize:20,
    beforePageText:"第",
...
EM.setCookie = function(value){
	var days = 30; 
    var exp = new Date(); 
    exp.setTime(exp.getTime() + days*24*60*60*1000); 
    document.cookie = "em_ext="+ escape (value) + ";expires=" + exp.toGMTString(); 
}
